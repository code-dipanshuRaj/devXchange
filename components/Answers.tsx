...
import { avatars, tableDB } from "@/models/client/config";
...
const Answers = ({
    ...
    answers: Models.RowList<AnswerWithAuthor>;
    questionId: string;
}) => {
                ...
                <div key={answer.$id} className="flex gap-4">
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <div className="mt-4 flex items-center justify-end gap-1">
                            <picture>
                                <img
                                    src={avatars.getInitials({name : answer.author.name, width : 36, height : 36})}
